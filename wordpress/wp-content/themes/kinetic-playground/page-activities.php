...
<main class="max-w-7xl mx-auto px-6 pt-16">
    ...
    <header class="text-center mb-20">
        <h1 class="font-headline text-5xl md:text-7xl font-extrabold text-primary mb-6 tracking-tight">
            <?php echo esc_html( kp_t( 'activities_h1_1' ) ); ?> <span class="text-primary-container"><?php echo esc_html( kp_t( 'activities_h1_2' ) ); ?></span>
        </h1>
        <p class="text-on-surface-variant text-xl max-w-2xl mx-auto leading-relaxed">
            <?php echo esc_html( kp_t( 'activities_subtitle' ) ); ?>
        </p>
    </header>
    ...
    <div class="flex flex-col md:flex-row justify-between items-center mb-12 gap-6">
        <div class="flex flex-wrap justify-center gap-3">
            <button class="px-6 py-2 rounded-full bg-primary text-white font-semibold shadow-lg hover:shadow-xl transition-all"><?php echo esc_html( kp_t( 'activities_filter_all' ) ); ?></button>
            <button class="px-6 py-2 rounded-full bg-surface-container-high text-on-surface-variant font-semibold hover:bg-primary-container hover:text-on-primary-container transition-all"><?php echo esc_html( kp_t( 'activities_filter_tots' ) ); ?></button>
            <button class="px-6 py-2 rounded-full bg-surface-container-high text-on-surface-variant font-semibold hover:bg-primary-container hover:text-on-primary-container transition-all"><?php echo esc_html( kp_t( 'activities_filter_expl' ) ); ?></button>
            <button class="px-6 py-2 rounded-full bg-surface-container-high text-on-surface-variant font-semibold hover:bg-primary-container hover:text-on-primary-container transition-all"><?php echo esc_html( kp_t( 'activities_filter_aces' ) ); ?></button>
        </div>
        <div class="relative w-full md:w-auto">
            <span class="material-symbols-outlined absolute left-4 top-1/2 -translate-y-1/2 text-on-surface-variant">search</span>
            <input type="text" class="w-full md:w-64 pl-12 pr-6 py-3 bg-surface-container-high rounded-full border-none focus:ring-2 focus:ring-primary-container focus:ring-opacity-50 text-on-surface placeholder-on-surface-variant/60" placeholder="<?php echo esc_attr( kp_t( 'activities_search' ) ); ?>" />
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        <div class="bg-surface-container-lowest rounded-xl overflow-hidden group hover:-translate-y-2 transition-transform duration-500 shadow-sm hover:shadow-xl">
            <div class="relative h-64 overflow-hidden">
                ...
                <div class="absolute top-4 left-4">
                    <span class="px-4 py-1 rounded-full bg-secondary-container text-on-secondary-container font-bold text-xs"><?php echo esc_html( kp_t( 'act_arts_age' ) ); ?></span>
                </div>
            </div>
            <div class="p-8">
                ...
                <h3 class="font-headline text-2xl font-bold mb-3 text-on-surface"><?php echo esc_html( kp_t( 'act_arts_title' ) ); ?></h3>
                <p class="text-on-surface-variant mb-6 line-clamp-2"><?php echo esc_html( kp_t( 'act_arts_desc' ) ); ?></p>
                <a href="#" class="w-full py-4 px-6 rounded-xl font-bold border-2 border-primary-container text-primary hover:bg-primary-container hover:text-on-primary-container transition-all flex items-center justify-center gap-2">
                    <?php echo esc_html( kp_t( 'activities_learn_more' ) ); ?> <span class="material-symbols-outlined text-sm">arrow_forward</span>
                </a>
            </div>
        </div>
        ...
        <div class="bg-surface-container-lowest rounded-xl overflow-hidden group hover:-translate-y-2 transition-transform duration-500 shadow-sm hover:shadow-xl lg:mt-8">
            <div class="relative h-64 overflow-hidden">
                ...
                <div class="absolute top-4 left-4">
                    <span class="px-4 py-1 rounded-full bg-tertiary-container text-on-tertiary-container font-bold text-xs"><?php echo esc_html( kp_t( 'act_science_age' ) ); ?></span>
                </div>
            </div>
            <div class="p-8">
                ...
                <h3 class="font-headline text-2xl font-bold mb-3 text-on-surface"><?php echo esc_html( kp_t( 'act_science_title' ) ); ?></h3>
                <p class="text-on-surface-variant mb-6 line-clamp-2"><?php echo esc_html( kp_t( 'act_science_desc' ) ); ?></p>
                <a href="#" class="w-full py-4 px-6 rounded-xl font-bold border-2 border-primary-container text-primary hover:bg-primary-container hover:text-on-primary-container transition-all flex items-center justify-center gap-2">
                    <?php echo esc_html( kp_t( 'activities_learn_more' ) ); ?> <span class="material-symbols-outlined text-sm">arrow_forward</span>
                </a>
            </div>
        ...
        <div class="bg-surface-container-lowest rounded-xl overflow-hidden group hover:-translate-y-2 transition-transform duration-500 shadow-sm hover:shadow-xl">
            <div class="relative h-64 overflow-hidden">
                ...
                <div class="absolute top-4 left-4">
                    <span class="px-4 py-1 rounded-full bg-primary-container text-on-primary-container font-bold text-xs"><?php echo esc_html( kp_t( 'act_athletes_age' ) ); ?></span>
                </div>
            </div>
            <div class="p-8">
                ...
                <h3 class="font-headline text-2xl font-bold mb-3 text-on-surface"><?php echo esc_html( kp_t( 'act_athletes_title' ) ); ?></h3>
                <p class="text-on-surface-variant mb-6 line-clamp-2"><?php echo esc_html( kp_t( 'act_athletes_desc' ) ); ?></p>
                <a href="#" class="w-full py-4 px-6 rounded-xl font-bold border-2 border-primary-container text-primary hover:bg-primary-container hover:text-on-primary-container transition-all flex items-center justify-center gap-2">
                    <?php echo esc_html( kp_t( 'activities_learn_more' ) ); ?> <span class="material-symbols-outlined text-sm">arrow_forward</span>
                </a>
            </div>
        ...
        <div class="bg-surface-container-lowest rounded-xl overflow-hidden group hover:-translate-y-2 transition-transform duration-500 shadow-sm hover:shadow-xl lg:mb-8">
            <div class="relative h-64 overflow-hidden">
                ...
                <div class="absolute top-4 left-4">
                    <span class="px-4 py-1 rounded-full bg-secondary-container text-on-secondary-container font-bold text-xs"><?php echo esc_html( kp_t( 'act_rhythm_age' ) ); ?></span>
                </div>
            </div>
            <div class="p-8">
                <div class="organic-blob w-12 h-12 bg-secondary-container/30 flex items-center justify-center mb-4">
                ...
                <h3 class="font-headline text-2xl font-bold mb-3 text-on-surface"><?php echo kp_t( 'act_rhythm_title' ); ?></h3>
                <p class="text-on-surface-variant mb-6 line-clamp-2"><?php echo esc_html( kp_t( 'act_rhythm_desc' ) ); ?></p>
                <a href="#" class="w-full py-4 px-6 rounded-xl font-bold border-2 border-primary-container text-primary hover:bg-primary-container hover:text-on-primary-container transition-all flex items-center justify-center gap-2">
                    <?php echo esc_html( kp_t( 'activities_learn_more' ) ); ?> <span class="material-symbols-outlined text-sm">arrow_forward</span>
                </a>
            </div>
        ...
        <div class="bg-surface-container-lowest rounded-xl overflow-hidden group hover:-translate-y-2 transition-transform duration-500 shadow-sm hover:shadow-xl">
            <div class="relative h-64 overflow-hidden">
                ...
                <div class="absolute top-4 left-4">
                    <span class="px-4 py-1 rounded-full bg-tertiary-container text-on-tertiary-container font-bold text-xs"><?php echo esc_html( kp_t( 'act_nature_age' ) ); ?></span>
                </div>
            </div>
            <div class="p-8">
                <div class="organic-blob w-12 h-12 bg-tertiary-container/30 flex items-center justify-center mb-4">
                ...
                <h3 class="font-headline text-2xl font-bold mb-3 text-on-surface"><?php echo esc_html( kp_t( 'act_nature_title' ) ); ?></h3>
                <p class="text-on-surface-variant mb-6 line-clamp-2"><?php echo esc_html( kp_t( 'act_nature_desc' ) ); ?></p>
                <a href="#" class="w-full py-4 px-6 rounded-xl font-bold border-2 border-primary-container text-primary hover:bg-primary-container hover:text-on-primary-container transition-all flex items-center justify-center gap-2">
                    <?php echo esc_html( kp_t( 'activities_learn_more' ) ); ?> <span class="material-symbols-outlined text-sm">arrow_forward</span>
                </a>
            </div>
        ...
        <div class="bg-surface-container-lowest rounded-xl overflow-hidden group hover:-translate-y-2 transition-transform duration-500 shadow-sm hover:shadow-xl lg:mt-8">
            <div class="relative h-64 overflow-hidden">
                ...
                <div class="absolute top-4 left-4">
                    <span class="px-4 py-1 rounded-full bg-primary-container text-on-primary-container font-bold text-xs"><?php echo esc_html( kp_t( 'act_tech_age' ) ); ?></span>
                </div>
            </div>
            <div class="p-8">
                <div class="organic-blob w-12 h-12 bg-primary-container/30 flex items-center justify-center mb-4">
                ...
                <h3 class="font-headline text-2xl font-bold mb-3 text-on-surface"><?php echo esc_html( kp_t( 'act_tech_title' ) ); ?></h3>
                <p class="text-on-surface-variant mb-6 line-clamp-2"><?php echo esc_html( kp_t( 'act_tech_desc' ) ); ?></p>
                <a href="#" class="w-full py-4 px-6 rounded-xl font-bold border-2 border-primary-container text-primary hover:bg-primary-container hover:text-on-primary-container transition-all flex items-center justify-center gap-2">
                    <?php echo esc_html( kp_t( 'activities_learn_more' ) ); ?> <span class="material-symbols-outlined text-sm">arrow_forward</span>
                </a>
            </div>
    ...
    <section class="mt-24 mb-20 bg-primary-container rounded-xl p-12 relative overflow-hidden flex flex-col md:flex-row items-center justify-between gap-12">
        <div class="relative z-10 max-w-xl">
            <h2 class="font-headline text-4xl font-extrabold text-on-primary-container mb-6 leading-tight"><?php echo kp_t( 'summer_title' ); ?></h2>
            <p class="text-on-primary-container/80 text-lg mb-8"><?php echo esc_html( kp_t( 'summer_desc' ) ); ?></p>
            <a href="<?php echo esc_url( kp_url( '/join' ) ); ?>" class="inline-block bg-primary text-white font-bold px-10 py-4 rounded-full shadow-lg hover:shadow-2xl hover:-translate-y-1 transition-all"><?php echo esc_html( kp_t( 'summer_cta' ) ); ?></a>
        </div>
        <div class="relative z-10 w-full md:w-1/3">
            <div class="bg-white/30 backdrop-blur-md rounded-xl p-6 shadow-xl rotate-3 transform">
                <div class="flex items-center gap-4 mb-4">
                    ...
                    <div>
                        <p class="font-bold text-on-primary-container"><?php echo esc_html( kp_t( 'summer_pass_label' ) ); ?></p>
                        <p class="text-xs text-on-primary-container/60"><?php echo esc_html( kp_t( 'summer_pass_valid' ) ); ?></p>
                    </div>
                </div>
                <div class="h-2 w-full bg-white/20 rounded-full mb-4"></div>
                <p class="text-2xl font-black text-on-primary-container"><?php echo esc_html( kp_t( 'summer_pass_price' ) ); ?><span class="text-sm font-normal"><?php echo esc_html( kp_t( 'summer_pass_period' ) ); ?></span></p>
            </div>
        </div>
